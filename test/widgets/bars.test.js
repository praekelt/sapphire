describe("sapphire.widgets.bars", function() {
  ...
  it("should show its bars", function() {
    ...
    expect(el.selectAll('.sph-bar').size()).to.equal(3);
    ...
    var bar = el.select('.sph-bar:nth-child(1)');
    ...
    bar = el.select('.sph-bar:nth-child(1)');
  ...
  it("should colour its bars", function() {
    ...
    expect(el.selectAll('.sph-bar').size()).to.equal(3);
    expect(el.select('.sph-bar:nth-child(1) rect').style('fill')).to.equal(color);
    expect(el.select('.sph-bar:nth-child(2) rect').style('fill')).to.equal(color);
    expect(el.select('.sph-bar:nth-child(3) rect').style('fill')).to.equal(color);
